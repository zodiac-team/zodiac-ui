...
const AIO_PATH = resolve(PROJECT_ROOT, 'apps/docs');
const TEMPLATES_PATH = resolve(PROJECT_ROOT, 'dgeni/tools/transforms/templates');
...
const API_SOURCE_PATH = resolve(PROJECT_ROOT, 'libs');
