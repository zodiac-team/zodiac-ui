...
export function ngOnChanges<T, U extends { ngOnChanges: Function } = any>(source: U): Observable<TypedChanges<T>> {
...
export function ngAfterContentInit<T extends { ngAfterContentInit: Function }>(source: T): Observable<void> {
    return createLifecycleHook(source, "ngAfterContentInit", true)
}

export function ngAfterContentChecked<T extends { ngAfterContentChecked: Function }>(source: T): Observable<void> {
    return createLifecycleHook(source, "ngAfterContentChecked")
}

export function ngAfterViewInit<T extends { ngAfterViewInit: Function }>(source: T): Observable<void> {
    return createLifecycleHook(source, "ngAfterViewInit", true)
}

export function ngAfterViewChecked<T extends { ngAfterViewChecked: Function }>(source: T): Observable<void> {
