...
export function NgOnChanges<T extends NgObservable<any>>(): (target: T, propertyKey: string) => void {
...
export function NgAfterContentInit<T extends NgObservable<any>>(): (target: T, propertyKey: string) => void {
    return function (target, propertyKey) {
        return decorateLifecycle(target, propertyKey, "ngAfterContentInit")
    }
}

export function NgAfterContentChecked<T extends NgObservable<any>>(): (target: T, propertyKey: string) => void {
    return function (target, propertyKey) {
        return decorateLifecycle(target, propertyKey, "ngAfterContentChecked")
    }
}

export function NgAfterViewInit<T extends NgObservable<any>>(): (target: T, propertyKey: string) => void {
    return function (target, propertyKey) {
        return decorateLifecycle(target, propertyKey, "ngAfterViewInit")
    }
}

export function NgAfterViewChecked<T extends NgObservable<any>>(): (target: T, propertyKey: string) => void {
    return function (target, propertyKey) {
        return decorateLifecycle(target, propertyKey, "ngAfterViewChecked")
    }
}

export function NgOnDestroy<T extends NgObservable<any>>(): (target: T, propertyKey: string) => void {
    return function (target, propertyKey) {
